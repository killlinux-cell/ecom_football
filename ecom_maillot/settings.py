"""
Django settings for ecom_maillot project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ks99&9o(6@n%y5ukn_+a=bkm)h!=rww9tn3mrm+ecj9f$+931a')
...
ALLOWED_HOSTS = ['localhost','127.0.0.1','orapide.shop','www.orapide.shop','testserver']
...
ROOT_URLCONF = 'ecom_maillot.urls'
...
WSGI_APPLICATION = 'ecom_maillot.wsgi.application'
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Changé de 'mandatory' à 'none' pour simplifier
...
WAVE_PAYMENT_ENABLED = config('WAVE_PAYMENT_ENABLED', default=True, cast=bool)

# Wave API Configuration (pour QR code avec montant pré-rempli)
WAVE_MERCHANT_ID = config('WAVE_MERCHANT_ID', default='')
WAVE_API_KEY = config('WAVE_API_KEY', default='')
WAVE_SECRET_KEY = config('WAVE_SECRET_KEY', default='')
